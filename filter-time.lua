...
local time_period_items = {
    {
        time = 60*2,
        text = "rocket-log.time-2m"
    },
    {
        time = 60*15,
        text = "rocket-log.time-15m"
    },
    {
        time = 60*60*1,
        text = "rocket-log.time-1h"
    },
    {
        time = 60*60*3,
        text = "rocket-log.time-3h"
    },
    {
        time = 60*60*6,
        text = "rocket-log.time-6h"
    },
    {
        time = 60*60*12,
        text = "rocket-log.time-12h"
    },
    {
        time = 60*60*24,
        text = "rocket-log.time-24h"
    }
}
